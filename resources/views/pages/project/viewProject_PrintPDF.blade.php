            ...
            <div class="card card-danger card-outline card-tabs">
              ...
              <div class="card-header p-0 pt-1 border-bottom-0">
                <ul class="nav nav-tabs" id="custom-tabs-three-tab" role="tablist">
                  <li class="nav-item">
                    <a class="nav-link active {{$collect_status_update->get('class_tabs')}}" id="custom-tabs-three-home-tab" href="{{$collect_status_update->get('href_tabs1')}}" role="tab" aria-controls="custom-tabs-three-home" aria-selected="false">REPORT PROJECT - {{$Dataproject->name_location}}</a>
                  </li>
                </ul>
              </div>
